...
//Select Workflow 
WebUI.click(findTestObject('Object Repository/WebClient_RF-SMART/lnk_Putaway02'))
...
WebUI.setText(findTestObject('Object Repository/WebClient_RF-SMART/txt_Receipt'), '2844')
